...
class Crawler:
    ...
    def printStats(self):
        outFile = open("analytics.txt",'w',encoding = 'utf-8')
        ...
        outFile.write("-----------------------#1----------------------------\n")
        outFile.write("--------------Domains and Output Link Count----------\n")
        for d, c in self.domainAndOutputLinks.items():
            outFile.write((f"Domain: {d}, OutputLinksCount: {c}\n"))
        ...
        outFile.write("\n-----------------------#2----------------------------\n")
        outFile.write(f"Most Valid Output Page: {self.maxValidOutLinks[0]} with {self.maxValidOutLinks[1]} Valid links\n");
        
        #3  List of downloaded URLs and identified traps.
        outFile.write("\n-----------------------#3----------------------------\n")
        outFile.write("-------------------Trap URLs-------------------------\n") 
